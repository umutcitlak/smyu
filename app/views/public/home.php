...
<section>
	<article>		
		<div class="head">Son 5 Icerik</div>
		<?php foreach($values["article2_content"] as $contents) {?>
		<div class="content">
	...
	<aside>
		<div class="head">Son 5 Etkinlik</div><!-- DUZENLENECEK-->
		<div class="content">
			<ul>
				<li>
					...
					<div class="content-body">8:00 am</div>
				</li>
				<li>
				...
				<li>
					...
					<div class="content-body">5:00 pm</div>
				</li>
				<li>
