<section>
	<article>
		<div class="head"><?php echo $values["article_content"][0]["content_head"]; ?></div>
		...
		<div class="content">
			...
			<div class="content-body"><?php echo $contents["content_body"] ; ?></div>
		</div>
		<?php } ?>
		...
		<div class="content">			 
			...
			<div class="comment-right">
				<div class="content-date"><?php echo $comments['comment_date']; ?></div>
				<div class="content-head"><a href="?url=user&no=<?php echo $comments["user_no"]; ?>"><?php echo $comments['user_name']; ?></a></div>	
				<div class="content-body"><?php echo $comments['comment_body']; ?></div>
			</div>
		</div>
		<?php } ?>
		...
		<div class="content">	
			...
			<div class="comment-right">
				<form action="" method="post">
					<textarea id="" name="comment_body" rows="10" placeholder="Yorum..." required ></textarea>
